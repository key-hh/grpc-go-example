...
type HelloReply struct {
	...
	Projects map[string]int32     `protobuf:"bytes,3,rep,name=projects,proto3" json:"projects,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` //google.protobuf.Any details = 3;
}
...
var file_hello_hello_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x61, 0x67, 0x65, 0x22, 0x86, 0x02, 0x0a, 0x0a, 0x48, 0x65,
	...
	0x63, 0x74, 0x73, 0x1a, 0x30, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x12, 0x0a,
...
var file_hello_hello_proto_depIdxs = []int32{
	...
	0, // 2: hello.Greeter.SayHello:input_type -> hello.HelloRequest
